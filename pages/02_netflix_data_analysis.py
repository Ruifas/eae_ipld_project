...
avg_title_length = round(17.725899852390143)
...
top_10_countries = countries_series.value_counts().head(10)
...
movies_avg_duration_per_year = movies_only.groupby("release_year")["duration_min"].mean().dropna().sort_index()
